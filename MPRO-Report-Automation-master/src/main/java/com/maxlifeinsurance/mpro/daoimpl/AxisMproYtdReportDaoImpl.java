...
public class AxisMproYtdReportDaoImpl implements AxisMproYtdReportDao {
	 ...
	 * This method will fetch data from database for Axis-Mpro-YTD Data
	 */
	@Override
...
//			MongoCollection<Document> collection = new DbConfigForLocal().getDbConnection(mongoDatabaseName);
			...
			whereCondition.append("channelDetails.channel", System.getenv(StringConstants.CHANNEL))
					.append("applicationDetails.createdTime", new Document(StringConstants.GREATER_THEN_EQUALS_TO, MultiFormatDate.getPreviousMonthDate(context)))
					.append("applicationDetails.stage", new Document(StringConstants.GREATER_THEN_EQUALS_TO, System.getenv(StringConstants.STAGES)));
